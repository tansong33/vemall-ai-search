...
python src/data_build_annotation_tasks.py `
  ...
  --output data/annotation-tasks/all.jsonl `
  --format doccano

python src/data_assign_doccano_tasks.py `
  --input data/annotation-tasks/all.jsonl `
...
每个项目标完后导出 Doccano JSONL，文件放在本地受控目录，例如 `data/exports/batch-001/`。运行：

```powershell
python src/data_compare_doccano.py `
  --input product01=data/exports/batch-001/product01.jsonl `
  --input product02=data/exports/batch-001/product02.jsonl `
  --input product03=data/exports/batch-001/product03.jsonl `
  --input dev01=data/exports/batch-001/dev01.jsonl `
  --input dev02=data/exports/batch-001/dev02.jsonl `
  --input dev03=data/exports/batch-001/dev03.jsonl `
  --input dev04=data/exports/batch-001/dev04.jsonl `
  --input dev05=data/exports/batch-001/dev05.jsonl `
...
```powershell
python src/data_convert_doccano.py `
  --input data/exports/batch-001/final-adjudicated.jsonl `
